...
(function($) {
    ...
    function mainMap() {
        ...
        var locations = [
            [locationData('listings-single-page.html', '../dtsimages/cab/1.jpg', "Tom's Restaurant", '964 School Street, New York', '3.5', '12'), 30.3451889, 78.0206509, 1, '<i class="im im-icon-Car-2"></i>'],
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
            ...
            center: new google.maps.LatLng(30.3091945,78.0108066),
